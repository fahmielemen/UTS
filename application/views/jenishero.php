		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<?php foreach ($jenisHero_list as $key) { ?>
									<tr>
										...
										<!-- <td><?php echo $key->foto ?></td>
										 --> <td>
											<a href="<?php echo site_url('hero/index/').$key->id ?>" type="button" class="btn btn-info">Lihat Hero</a>
						...
						<left><li class="btn btn-info" ><a href="<?php echo site_url('jenishero/createJenis') ?>">Tambah Jenis Hero</a></li>
						</div>
					</div>
